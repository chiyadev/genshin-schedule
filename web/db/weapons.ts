...
add("The Alley Flash", Decarabian, [HilichurlHorn, SamachurlScroll]);
...
add("Elegy for the End", BorealWolf, [HilichurlHorn, FatuiInsignia]);
...
add("Windblume Ode", DandelionGladiator, [LeyLine, WhopperflowerNectar]);
...
add("Lithic Blade", Guyun, [FatuiKnife, HilichurlArrowhead]);
...
add("Staff of Homa", Aerosiderite, [LeyLine, Slime]);
